...
public class Constants
{
    ...
    public const int CELL_ELEVATION = 5;
    public const int LEFT_OFFSET = -100;
    public const int BOTTOM_OFFSET = -45;
    public const string CELL_COLOR_NORMAL = "#B9F6FFFF";
    public const string CELL_COLOR_VALID = "#00E62EFF";
    public const string CELL_COLOR_INVALID = "#E64100FF";
    public const int SHIP_AMOUNT = 2;
